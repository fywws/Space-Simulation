...
public class KeyManager implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener
{
	...
	public boolean up, down, left, right, shift, alt, upArrow, downArrow, leftArrow, rightArrow, debugMode, leftClick, rightClick, middleClick, mouseWheelUp, mouseWheelDown, dragging;
